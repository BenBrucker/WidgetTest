...
public class WidgetService extends Service {
	...
	public void onStart(Intent intent, int startId) {
		...
		ComponentName thisWidget = new ComponentName(getApplicationContext(), WidgetTest.class);
		...
		for (int widgetId : allWidgetIds) {
			...
			Intent clickIntent = new Intent(this.getApplicationContext(), WidgetTest.class);
